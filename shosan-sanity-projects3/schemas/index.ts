...
import shosan_acodemia from './shosanAcodemiaSchema'
import nationality from './nationality'


const schemas = [productSchema, shosan_acodemia, nationality];





export const schemaTypes = [...annotations, ...documents, ...singletons, ...objects, ...blocks, ...schemas]
